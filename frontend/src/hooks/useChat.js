...
export const useChat = (userId = 'default-user') => {
  ...
  const startNewConversation = useCallback(() => {
    ...
    // Add a welcome message to ensure the chat interface shows
    const welcomeMessage = {
      id: `welcome-${Date.now()}`,
      type: 'ai',
      content: "Hello! I'm your prenatal AI assistant. I'm here to help with any questions about your pregnancy journey. What would you like to know?",
      timestamp: new Date(),
      status: 'received'
    };
