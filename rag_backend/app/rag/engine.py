        ...
        def call_model(state):
            ...
            if not any(msg.type == "system" for msg in messages):
                system_message = SystemMessage(content=
                    ...
                    "- Use **bold text** for emphasis by wrapping text with **\n"
                    "- Use numbered lists (1. 2. 3.) or bullet points (- item) for clarity\n"
                    "- Format all URLs as clickable markdown links using this syntax: [link text](URL)\n"
                    "- For example: [RACGP Genomics Guide](https://www.racgp.org.au/getattachment/63568f23-e288-4a0e-a23a-39fbd046cc21/Genomics-in-general-practice.aspx)\n"
                    "- When citing Genomics.pdf specifically, always format it as: [RACGP Genomics in General Practice](https://www.racgp.org.au/getattachment/63568f23-e288-4a0e-a23a-39fbd046cc21/Genomics-in-general-practice.aspx)\n"
                    "- For other sources, create descriptive link text rather than showing raw URLs\n"
                    "\n\n"
                    "If no relevant documents are found, you do not need to mention that, just use your existing knowledge to answer the question. "
